<div class="row">
    <div class="col-12">
        ...
        <div class="card shadow mb-4">
            ...
            <form method="POST" action="{{route('users.update', ['user' => $user->id])}}" class="default_form">
                @csrf
                @method('PUT')
                <div class="card-body">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input 
                            ...
                            name="mobile_number" 
                            value="{{ old('mobile_number') ? old('mobile_number') : $user->mobile_no }}">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <select class="form-control form-control-user @error('role_id') is-invalid @enderror" name="role_id">
                            ...
                            @foreach ($roles as $key => $role)
                                <option value="{{$key}}" {{ $user->role == $role  ? "selected" : "" }}>{{$role}}</option>
                            @endforeach
                        </select>
                        @error('role_id')
                            <span class="text-danger">{{$message}}</span>
