<div class="row">
    <div class="col-12">
        ...
        <div class="card shadow mb-4">
            ...
            <form method="POST" action="{{route('category.store')}}" class="default_form">
                @csrf
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control form-control-user @error('category_name') is-invalid @enderror" id="exampleCategoryName" placeholder="Category Name" name="category_name" value="{{ old('category_name') }}">
